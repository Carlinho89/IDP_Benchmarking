...
public class Scenario {
    ...
    private final DataConnection connection;   //Connect to database
    ...
    public Scenario(String league, String inputStr, String outputStr, boolean orientation, boolean superEff, int start, int seasons) throws Exception   //Single-Stage constructor
    {
    ...
    public Scenario(String league, String inputStr, String interOneStr, String interTwoStr, String outputStr, boolean[][]setting, boolean superEff, int start, int seasons)
    {
        this.connection = new DataConnection();  //Establish connection to database
    ...
    public void computeMQI(String inputStr, String interOneStr, String interTwoStr, String outputStr, int scale) throws Exception {
